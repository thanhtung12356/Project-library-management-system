...
namespace PhanHeDocGia
{
    public class SButton : CheckBox
    {
        ...
        public SButton()
        {
            this.MinimumSize = new Size(85, 35);
        }
        //Methods
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (this.Checked) //ON
            {
                ...
                {
                    SizeF textSize = TextRenderer.MeasureText("Yes", font);
                    float x = 4; // Adjust as needed
                    float y = (this.Height - textSize.Height) / 2;
                    pevent.Graphics.DrawString("Yes", font, Brushes.White, new PointF(x, y));
                }
            }
            else //OFF
            {
                ...
                using (Font font = new Font("Arial", 8, FontStyle.Bold))
                {
                    SizeF textSize = TextRenderer.MeasureText("No", font);
                    float x = this.Width - textSize.Width - 4; // Adjust as needed
                    float y = (this.Height - textSize.Height) / 2;
                    pevent.Graphics.DrawString("No", font, Brushes.White, new PointF(x, y));
                }
            }
        }
    }
